...
for iF=1:mskCplus.nFaces;
   ...
   mskWedge{iF}=mskWedge{iF}*-1;
   mskSedge{iF}=mskCplus{iF}(2:end-1,2:end-1) - mskCplus{iF}(2:end-1,1:end-2);
   else
   mskWedge{iF}=mskCplus{iF}(2:end-1,2:end-1) - mskCplus{iF}(2:end-1,1:end-2);
   mskSedge{iF}=mskCplus{iF}(2:end-1,2:end-1) - mskCplus{iF}(1:end-2,2:end-1);
   mskSedge{iF}=mskSedge{iF}*-1;
   end
end;
