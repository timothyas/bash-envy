...
%   \end{figure}
 ...
 \section{Sensitivity means}
   ...
   \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{dec.240mo/adjMean_atemp}
   ...
   \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{nov.240mo/adjRMS_hflux}
  ...
  Next are plots showing the reconstruction of AMOC at 34S. 
   ...
   \begin{figure}
    \centering
    \includegraphics[width=\textwidth]{../../tpsla/plots/36mo/fig1}
 ...
 %  \begin{figure}
 %   \centering
 %   \includegraphics[width=\textwidth]{reconstruction/full}
 ...
 %  \begin{figure}
 %   \centering
 %   \includegraphics[width=\textwidth]{reconstruction/full_fluxes}
 %   \caption{SAMOC reconstructed with monthly accumulated sensitivities and forcing files (wind stress, net heat flux, and net salt flux). ``Memory'' time is 20 years.}
 %   \label{fig:fullSamoc_fluxes}
 %  \end{figure}
