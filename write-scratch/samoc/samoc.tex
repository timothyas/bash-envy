...
\label{setup}
 ...
 \section{Sensitivity Maps}
  ...
  The contribution to $\delta\mathcal{J}(t)$ from heat and salt flux show a very different behavior than in Pillar \cite{pillar}. In the Pillar paper there seems to be a roughly decadal mode appearing from heat flux reconstruction, with very little variation due to salt flux.
