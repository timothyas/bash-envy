...
\label{setup}
 ...
 \section{Sensitivity Maps}
  ...
  \subsection{Exploring reconstruction memory}

  The contribution to $\delta\mathcal{J}(t)$ from heat and salt flux show a very different behavior than in Pillar \cite{pillar}. 
